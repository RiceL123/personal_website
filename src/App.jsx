      ...
      <div className="main m-2 md:m-6">
        <div className='flex'>
          <div className='group min-w-40 min-h-40 lg:min-h-64 lg:min-w-64 my-auto'>
            ...
            <p className='invisible group-hover:visible text-[0.6em] text-center'>your're welcome for the clarification</p>
          </div>
          <div className='m-2'>
        ...
        <div className='m-3'>
          <p>asdasdkjsah daskjdh askdjsa hlkdjsah dlkjsahd salkjh daskldjh salkjdh salkdj haskdjs ahdlkjsahd lkasjhdls akjdh salkdh salkdjah sljdkhaslk jdhalskjdhsal</p>
        </div>
        <Education />
        <Work />
        <Projects />
