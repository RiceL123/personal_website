      ...
      <div className="main m-2 md:mx-6">
        <div className='flex'>
          <div className='group relative min-w-40 min-h-40 lg:min-h-64 lg:min-w-64 my-auto overflow-hidden'>
            <img src="https://cdn.discordapp.com/attachments/848817257303900162/1207625312779763762/ohno__clarifications.jpg?ex=65e053b7&is=65cddeb7&hm=1412b276ae1c9dcbe1328e0f024b7a0e5aa54b2efa588879f8f49a0880ad84fe&" alt="display photo" className='object-contain w-40 h-40 lg:h-64 lg:w-64 rounded-md shadow-lg disabled' />
